...
const ResultPage = () => {
    ...
    console.log(param, score, total, unAnswered);
    ...
    if (score === undefined || total === undefined || unAnswered
        === undefined) { 
            return (
                <div>
    ...
    return (
        <div className="result-page container">
            ...
            <p><strong>Unanswered Questions:</strong> {unAnswered}</p>
            <p><strong>Feedback:</strong> {getFeedback()}</p>
